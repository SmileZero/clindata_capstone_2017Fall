function addDrug() {
    ...
    var reporedRoleInput = '<div class="form-group col-md-3"><label for="role-select-' +  seq + '">Reported Role</label> <select class="form-control" name="reported-role" id="role-select-' + seq + '"> <option value="PS" selected>(PS) Primary Suspect Drug</option> <option value="SS">(SS) Secondary Suspect Drug</option> <option value="C">(C) Concomitant</option> <option value="I">(I) Interacting</option> </select> </div>';
    var dechalInput = '<div class="form-group col-md-3"><label for="dechal-select-' + seq + '">Dechallenge Code</label><select class="form-control" name="dechal" id="dechal-select-' + seq + '"> <option value="Y" selected>(Y) Positive Dechallenge</option> <option value="N">(N) Negative Dechallenge</option> <option value="U">(U) Unknown</option> <option value="D">(D) Does Not Apply</option> </select> </div>';
    var rechalInput = '<div class="form-group col-md-3"> <label for="rechal-select-' + seq + '">Rechallenge Code</label> <select class="form-control" name="rechal" id="rechal-select-' + seq + '"> <option value="Y" selected>(Y) Positive Rechallenge</option> <option value="N">(N) Negative Rechallenge</option> <option value="U">(U) Unknown</option> <option value="D">(D) Does Not Apply</option> </select> </div> </div>';
